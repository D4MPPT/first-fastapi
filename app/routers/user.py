...
from .. import models, scheemas, utils
...
@router.post("/", status_code=status.HTTP_201_CREATED, response_model = scheemas.UserOut)
...
@router.get("/{id}", response_model = scheemas.UserOut)
